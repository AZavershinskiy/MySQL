...
-- 1. Create database
CREATE DATABASE
    IF NOT EXISTS lesson_1;

-- CREATE DATABASE lesson_1 IF it DOES NOT EXIST
...
-- TABLE COLUMNS analytics of the TABLE student
